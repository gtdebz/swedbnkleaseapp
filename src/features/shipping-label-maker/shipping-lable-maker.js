                ...
                <>
                    ...
                    >
                        <div style={{ padding: '30px' }}>
							...
							<h3 style={{backgroundColor: "#ffcc00"}}><center>Shipping Details Confirmation</center></h3>
							<section><center>A receipt will be printed once confirmation is made</center></section>
                            <h4>Confirm Your Shipping Choices</h4>
                            <h3>From </h3>
                            <List>
                                <ListItem>
